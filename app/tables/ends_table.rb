class EndsTable < TableCloth::Base
  # Define columns with the #column method
  # column :name, :email

  column :distance, :uom, :shots_list, :score, :x_count, :mulligan, :created_at
  ...
  config.table.class = 'table table-bordered table-hover table-condensed table-responsive ends_table'
  config.thead.class = ''
  config.th.class    = ''
  config.tbody.class = ''
  config.tr.class    = ''
